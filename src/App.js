 ...
 * We will now use a Firebase Cloud Function to make this call securely.
*/

// --- Secure API Helper via Firebase Cloud Functions ---
/**
 * Calls a Firebase Cloud Function to securely generate text using the Gemini API.
 * @param {object} functions - The Firebase Functions instance.
 * @param {string} prompt - The prompt to send to the Gemini API.
 * @returns {Promise<string>} The text generated by the API.
 */
